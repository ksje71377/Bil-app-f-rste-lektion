...
namespace Bil_app__første_lektion
{
    internal class Program
    {
        ...
        {
            /*
             * Dette er Team14's biloplysnings projekt med beregninger om tur og brændstof.
             * Lavet af UCL Studerende på Online Datamatiker uddannelsen. Dato: Feb 2025.
             * Copyright (c) 2025 Team14 - DMOoF25 UCL Erhvervsakademi.
             */
            
            //Alle variablerne i eksplicit form.
            string bilModel;
            int bilÅrgang;
            char bilGearkasse;
            char bilBrændstof;
            ...
            //Velkomst Intro og ny linje.
            Console.WriteLine("Velkommen til CarApp version 1.0\n");
            
            //Spørgsmål: Bil-Fabrikant med feedback fra brugeren.
            Console.WriteLine("Hvilken fabrikant har lavet din bil?:");
            bilFabrikant = Console.ReadLine();
            
            //Spørgsmål: Bil-Model med feedback fra brugeren.
            Console.WriteLine("Hvilken model er din bil?");
            bilModel = Console.ReadLine();
            
            //Spørgsmål: Bil-Model med feedback fra brugeren konvertreret til int.
            Console.WriteLine("Hvor mange kilometer har bilen kørt?:");
            bilKilometerstand = Convert.ToInt32(Console.ReadLine());
            
            //Spørgsmål: Bil-Brændstoftype med feedback fra brugeren.
            Console.WriteLine("Hvilket slags brændstof bruger den? B for benzin, D for diesel");
            bilBrændstof = Console.ReadLine()[0];
            
            //Spørgsmål: Bil-Forbrug med feedback fra brugeren konverteret til double.
            Console.WriteLine("Hvor langt kører den på literen? (Angiv i km/l.):");
            bilForbrug = Convert.ToDouble(Console.ReadLine());
            
            //Spørgsmål: Bil-årgang med feedback fra brugeren konverteret til int.
            Console.WriteLine("Hvad årgang er din bil?");
            bilÅrgang = Convert.ToInt32(Console.ReadLine());
            
            //Spørgsmål: Bil-Gear type med feedback fra brugeren og kun første bogstav hentes.
            Console.WriteLine("Er bilens gear manuelt eller automatisk? Tast A for auto, M for manuel.");
            bilGearkasse = Console.ReadLine()[0];
            
            /*
             * Bestemmer beskrivelse af gearkasse og brændstoftype baseret på brugerens input.
             * - Hvis brugeren taster 'A', sættes gearBeskrivelse til "automatgear".
             * - Hvis brugeren taster 'M', sættes gearBeskrivelse til "manuelt gear".
             * - Hvis inputtet er noget andet, sættes gearBeskrivelse til "ukendt, du har tastet forkert input".
             *
             * På samme måde bestemmes brændstofBeskrivelse baseret på brugerens input:
             * - 'B' giver "benzin".
             * - 'D' giver "diesel".
             * - Andet input returnerer "ukendt brændstoftype".
             */
            ...
            //Oplysninger til brugeren, om bilen ud fra det der er blevet indtastet indtil nu.
            ...
            //Spørgsmål: Brændstofsøkonomi og input-feedback fra brugeren konverteret til double
            Console.WriteLine("\n\nIndtast venligst gældende pris for en liter brændstof:");
            brændstofPris = Convert.ToDouble(Console.ReadLine());
            
            //Spørgsmål: Bil-Tur og input-feedback fra brugeren konverteret til int
            ...
            //Bilberegninger for Brændstof og Pris samt opdateret kilometertal efter biltur
            ...
            //Oplysninger til brugeren, om bilen ud fra det der er blevet indtastet indtil nu.
            //Det er mere præcist at sige, at Console.WriteLine() har samme formatfunktionalitet som string.Format(), hvilket betyder, at vi ikke behøver at kalde string.Format() manuelt.
